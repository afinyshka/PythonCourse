...
if __name__ == '__main__':
    ...
    find = tk.Button(win, text="Find", relief=tk.RAISED, command=lambda: find_entry(
        "Contact's information:")).grid(row=0, column=2, stick="we")
    add = tk.Button(win, text="Create", relief=tk.RAISED, command=add_entry).grid(
        row=1, column=2, stick="we")
    delete = tk.Button(win, text="Remove", relief=tk.RAISED, command=delete_entry).grid(
        row=2, column=2, stick="we")
    edit = tk.Button(win, text="Edit", relief=tk.RAISED, command=edit_entry).grid(
        row=3, column=2, stick="we")
    export = tk.Button(win, text="Export", relief=tk.RAISED, command=export_to_csv).grid(
